...
public class Frm_Paciente extends javax.swing.JFrame {
    ...
    private Patient_BO pa_BO;

    public Frm_Paciente(Connection conexion) {
        initComponents();
        this.conexion = conexion;
        this.pa_BO = new Patient_BO();
        listarPatients();
    }

    private void listarPatients() {
        pa_BO.listarPatient(jTblPat);
    }

    private void limpiar() {
        this.txtApoderado.setValue(0);
        this.txtHistoria.setValue(0);
        this.txtDNI.setText("");
    ...
    private void initComponents() {
        ...
        txtApoderado = new javax.swing.JSpinner();
        txtHistoria = new javax.swing.JSpinner();
        ...
        jTblPat = new javax.swing.JTable();
        ...
        jLabel7.setText("Formulario Paciente");
        ...
        jLabel13.setText("ID Apoderado:");

        jLabel14.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(0, 0, 0));
        jLabel14.setText("ID Historia Clinica:");

        jLabel15.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel15.setForeground(new java.awt.Color(0, 0, 0));
        jLabel15.setText("DNI del Paciente: ");
        ...
        jLabel16.setText("Nombre (s) del Paciente: ");
        ...
        jLabel17.setText("Edad del Paciente:");

        jLabel18.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel18.setForeground(new java.awt.Color(0, 0, 0));
        jLabel18.setText("Apellidos del Paciente: ");

        jLabel19.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel19.setForeground(new java.awt.Color(0, 0, 0));
        jLabel19.setText("Diagnóstico del Paciente: ");
        ...
        jTblPat.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jTblPatMousePressed(evt);
            }
        });
        jScrollPane3.setViewportView(jTblPat);
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(txtApoderado, javax.swing.GroupLayout.PREFERRED_SIZE, 169, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(jLabel14)
                                .addGap(12, 12, 12)
                                .addComponent(txtHistoria, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(6, 6, 6)
    ...
    private void jTblPatMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTblPatMousePressed
        int rowSelected = jTblPat.getSelectedRow();
        System.out.println(rowSelected);
        try {
            int idPat = Integer.parseInt(this.jTblPat.getValueAt(rowSelected, 0).toString());
            int idApo = Integer.parseInt(this.jTblPat.getValueAt(rowSelected, 1).toString());
            int idHist = Integer.parseInt(this.jTblPat.getValueAt(rowSelected, 2).toString());
            this.txtID.setValue(idPat);
    ...
    private javax.swing.JSpinner txtHistoria;
