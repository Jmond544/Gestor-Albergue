...
public class Frm_SelectArea extends javax.swing.JPanel {

    private Connection conexion;
    private AreaBO em_BO;
    
    public Frm_SelectArea(Connection conexion) {
        initComponents();
        this.conexion = conexion;
        this.em_BO = new AreaBO();
        listarMedical_Exam();
    }

    private void listarMedical_Exam(){
        em_BO.listarArea(TBFormulario);
    }
